...
$(document).ready(function(){
		$(".btn-menu").click(function(e){
				...
				var maquina=$(this).attr("alt");
			console.log(maquina);
				if (filtro == "Desc"){
					
					
					$(".descripcion-p").filter("."+maquina).css("display","block");
				
					$(".espe").filter("."+maquina).css("display","none");
					
				}else if(filtro == "Especi"){
					
					$(".descripcion-p").filter("."+maquina).css("display","none");
					
					$(".espe").filter("."+maquina).css("display","block");
